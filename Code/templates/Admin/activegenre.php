                                ...
                                <div class="vc_column-inner vc_custom_1477912247150">
                                    <div class="wpb_wrapper">
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <h5><a href="http://localhost/code/admin/newgenre">+Generate new Genre</a></h5>
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Pop</td>
                                                        <td>Active</td>
                                                        <td><button type="Button" style="height:20px;width:10px text-align:center;">Activate</button></td>
                                                        <td><button type="Button" onclick="Success();" style="height:20px;width:10px text-align:center;">Deactivate</button></td>
                                                        <script>
                                                            function Success(){
                                                                alert("Promocode is deactivated!");
                                                            }
                                                        </script>
