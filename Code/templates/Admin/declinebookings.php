                                            ...
                                            <div class="wpb_wrapper">
                                                 <table>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td>$1200</td>
                                                        <td>9735369240</td>
                                                            <td><a href="<?= $this->Url->Build(['controller' => 'Admin', 'action' => 'updeclinebookings']) ?>">Cancel Booking</a></td>
                                                        </tr>
                    ...
                    <?php } else if ($userDetails->role_id === MUSICIAN_ROLE_ID) { ?>
                        ...
                        <ul class="product-categories">
                           ...
                           <li class="cat-item cat-item-38"><a href="#">Manage Customers</a></li>
                            ...
                            <li class="cat-item cat-item-36"><a href="<?= $this->Url->Build(['controller' => 'Admin', 'action' => 'upbookings']) ?>">Decline/Cancel Bookings</a></li>
