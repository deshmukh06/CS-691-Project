                                               ...
                                               <br>
                                                ...
                                                <script>
                                                    function Success(){
                                                        ...
                                                        window.location.href = "http://localhost/code/admin/errormanualbooking"
                                                    
                                                    }

                                                </script>
                                                &nbsp; <input type="Submit" value="Cancel" onclick= "window.location.href='http://localhost/code/admin/emanualbookings';"></br>
                                                        <br></br>
                                                        <br></br>
                                         </div>
                                        </div>
