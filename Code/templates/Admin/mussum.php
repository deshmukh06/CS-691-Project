                                    ...
                                    <div class="wpb_wrapper">
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
												...
												<tr> 
													<td rowspan="3">110</td> 
													<td rowspan="3">Fransisco Rockers</td> 
													<td>A453</td>
												...
												<tr> 
													...
													<tr> 
														<td rowspan="2">107</td> 
														<td rowspan="2">Blinding Stage</td> 
														<td>U765</td>
														<td>Rose Tylor</td>
													...
													<tr> 
														<td rowspan="5">116</td> 
														<td rowspan="5">Fantastic Four</td> 
														<td>G265</td>
														<td>Tom Jose</td>
														<td>April 19 2021</td> 
														<td>$5500</td>
        ...
        <div class="sidebar sidebar_left widget_area" role="complementary" style="margin-top: 150px !important; margin-bottom: 150px !important;">
            <div class="sidebar_inner">
                <div id="woocommerce_product_categories-2" class="widget woocommerce widget_product_categories">
                    <h5 class="widget_title">Musicians Booking Summary</h5>
