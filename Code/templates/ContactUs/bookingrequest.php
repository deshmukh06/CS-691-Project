                                        ...
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                ...
                                                <tr> 
                                                    ...
                                                    <td><br><button type="Button"style="height:20px;width:5px text-align:center;" onclick="Success()";>Accept</button></br>
                                                        <script>
                                                      
                                                    function Success(){
                                                        alert("Booking has been accepted successfully!");
                                                        window.location.href = "http://localhost/code/ContactUs/acceptedbookingrequest"
                                                    
                                                    }
                                                </script>
                                                    <br><button type="Button" style="height:20px;width:5px text-align:center;">Decline</button></br></td>
                                                ...
                                                <tr> 
                                                    ...
                                                    <p><br><button type="Button" style="height:20px;width:10px text-align:center;" onclick="Success();">Decline</button></br></td></p>
                                                    <script>
                                                        function Delete(){
