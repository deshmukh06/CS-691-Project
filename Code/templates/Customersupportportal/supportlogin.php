                            ...
                            <div class="vc_column-inner">
                                <div class="wpb_wrapper">
                                    <div id="sc_title_139639600" class="sc_title color_style_default sc_title_default" style="margin-bottom: 5.5em !important;">
                                        ...
                                        <h2 class="sc_item_title sc_title_title sc_align_center sc_item_title_style_default">Customer Support Portal</h2>
                                    </div>
                                    ...
                                    <div role="form" class="wpcf7" id="wpcf7-f1059-p144-o1" lang="en-US" dir="ltr">
                                        ...
                                        <div class="contact_us">
                                            ...
                                            <div class="flex">
                                                <div class="row">
                                                   <a style="color: #ffa752" href="<?= $this->Url->build(['controller' => 'Customersupportportal', 'action' => 'supportdashboard']) ?>">Forgot Password?</a>
                                                </div>
                                            </div>
                                        </div>
