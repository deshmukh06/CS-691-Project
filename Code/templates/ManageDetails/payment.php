                                ...
                                <div class="vc_column-inner vc_custom_1477912247150">
                                    <div class="wpb_wrapper">
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <h5>Hello <?= ucfirst($userDetails->first_name) ?>, these are your payment details</h5> 
                                                <p><b>Card Number: </b><?php echo "**** **** **** 1200";?></p>
                                                <p><b>Expiry Date: </b><?php echo "07/26";?></p>
                                                <p><b>CVV: </b><?php echo "***"  ?></p>
                                                <p><b>Name on card: </b><?php echo "Revati Deshmukh"  ?></p>
                                                <input type="Submit" value="Update Payment Details" onclick="window.location.href='http://localhost/code/manage-details/updatepay';">
                                                <input type="submit" value="Cancel" onclick="window.location.href='http://localhost/code/manage-details/view_details';">
        ...
        <div class="sidebar sidebar_left widget_area" role="complementary" style="margin-top: 150px !important; margin-bottom: 150px !important;">
            <div class="sidebar_inner">
                <aside id="woocommerce_product_categories-2" class="widget woocommerce widget_product_categories">
                    <h5 class="widget_title">Payment Details</h5>
