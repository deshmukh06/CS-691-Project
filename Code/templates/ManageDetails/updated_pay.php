                                ...
                                <div class="vc_column-inner vc_custom_1477912247150">
                                    <div class="wpb_wrapper">
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <h5>Payment information Updated!</h5> 
                                                <p><b>Card Number: </b><?php echo "**** **** **** 1888";?></p>
                                                <p><b>Expiry Date: </b><?php echo "10/28";?></p>
                                                <p><b>CVV: </b><?php echo "***"  ?></p>
                                                <p><b>Name on card: </b><?php echo "Reva Bharat"  ?></p>
                                                <input type="Submit" value="Update Payment Details" onclick="window.location.href='http://localhost/code/manage-details/updatedpay';">
                                                <input type="submit" value="Cancel" onclick="window.location.href='http://localhost/code/manage-details/updated_view_details';">
